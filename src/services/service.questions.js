...
class ServiceQuestion {
  ...
  async getDaVinci(data) {
    ...
    generatePrompt(question) {
        ...
        return `asnwer this question${capitalizedquestion}
        The format of your answer should be like this and it must be in spanish with min 500 characcters: 
        the answer to your question is "your answer" ;`;
